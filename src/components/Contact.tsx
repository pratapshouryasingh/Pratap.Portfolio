        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="glass rounded-3xl p-10 border border-gray-700/30 animate-slide-in-right hover-lift">
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-6 py-4 glass border border-gray-600 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/50 text-white transition-all duration-500 text-lg"
              ...
              <div>
                <label htmlFor="subject" className="block text-lg font-bold text-gray-300 mb-3">
                  Subject
                </label>
                <input
                  type="text"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={8}
                  className="w-full px-6 py-4 glass border border-gray-600 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/50 text-white transition-all duration-500 resize-none text-lg"
